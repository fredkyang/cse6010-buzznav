...
\begin{itemize}
    ...
    \item \textbf{Routing Output \& Instructions}: Fred Yang, Ming-Cheng Fan, Haowen Jiang
        \begin{itemize}
            ...
            \item Format results clearly for users (display text instructions instead of instead of nodes\_id).
    ...
    \item \textbf{Front-End UI}: Fred Yang, Chia-Hsin Chiu, Ming-Cheng Fan
        \begin{itemize}
            ...
            \item Implement interactive features such as selecting start and end locations, and highlighting routes.
